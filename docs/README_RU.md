...
Добро пожаловать в документацию "Продолжи, старец!" - AI-ассистента для разработчиков с поддержкой русского и тайского языков.
...
1. Скачайте `prodolzhi-starets.vsix` из релизов
2. Откройте VS Code
...
1. Скачайте `prodolzhi-starets-intellij.jar` из релизов
...
Создайте файл `.prodolzhi-starets/config.yaml`:
...
"Продолжи, старец!" воплощает принципы:
...
- [Репозиторий проекта](https://github.com/nativemind/prodolzhi-starets)
- [Telegram-канал](https://t.me/prodolzhi_starets)
